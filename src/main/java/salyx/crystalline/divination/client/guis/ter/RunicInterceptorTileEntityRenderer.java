...
public class RunicInterceptorTileEntityRenderer extends TileEntityRenderer<RunicInterceptorTile> {
    ...
    public void render(RunicInterceptorTile te, float partialTicks, MatrixStack matrixStackIn,
        ...
        renderBook(te, partialTicks, matrixStackIn, bufferIn, combinedLightIn, combinedOverlayIn);
    }
    ...
    private void renderBook(RunicInterceptorTile tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
        matrixStackIn.push();
